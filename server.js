// ============================================================
//  Philippines Remote Jobs Portal — Express Server
  ...
  const cards = featuredJobs
    ...
    <div class="job-card">
      ...
      <div class="meta">
        ...
        <span class="location">📍 ${j.city}, PH</span>
      </div>
    </div>`
    )
    .join("");
...
<head>
  ...
  <title>${SITE_NAME} — Work From Home Jobs Philippines 2025 | ${TOTAL_JOBS.toLocaleString()} Jobs</title>
  <meta name="description" content="Find ${TOTAL_JOBS.toLocaleString()} remote and work-from-home jobs in the Philippines. Top companies hiring now — Netflix, Amazon, Google, Apple, Delta Airlines and more!"/>
  ...
  <script type="application/ld+json">${JSON.stringify({
    ...
    name: SITE_NAME,
    url: BASE_URL,
    description: `${TOTAL_JOBS.toLocaleString()} Work From Home Jobs in Philippines`,
    potentialAction: {
      "@type": "SearchAction",
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    header{background:linear-gradient(135deg,#0038a8,#ce1127);color:#fff;padding:40px 20px;text-align:center}
    ...
    .stat{text-align:center}.stat b{display:block;font-size:1.5rem;color:#0038a8}
    .stat span{font-size:.85rem;color:#666}
    nav{background:#0038a8;padding:10px 20px;display:flex;gap:15px;flex-wrap:wrap}
    ...
    h2{font-size:1.4rem;margin-bottom:20px;color:#0038a8;border-left:4px solid #ce1127;padding-left:12px}
    .jobs-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(340px,1fr));gap:18px;margin-bottom:40px}
    .job-card{background:#fff;border-radius:10px;padding:20px;box-shadow:0 2px 8px rgba(0,0,0,.08);transition:transform .2s,box-shadow .2s;border-top:3px solid #0038a8}
    .job-card:hover{transform:translateY(-3px);box-shadow:0 6px 20px rgba(0,0,0,.13)}
    .company-tag{font-size:.78rem;background:#e8f0fe;color:#0038a8;padding:3px 10px;border-radius:20px;display:inline-block;margin-bottom:10px;font-weight:600}
    .job-card h3{font-size:1rem;margin-bottom:12px;line-height:1.4}
    .job-card h3 a{color:#1a1a2e;text-decoration:none}
    .job-card h3 a:hover{color:#0038a8}
    ...
    .company-chip{background:#fff;border:1px solid #0038a8;color:#0038a8;padding:6px 14px;border-radius:20px;text-decoration:none;font-size:.88rem;transition:all .2s}
    .company-chip:hover{background:#0038a8;color:#fff}
    .view-all{text-align:center;margin:20px 0 40px}
    .btn{background:#ce1127;color:#fff;padding:12px 30px;border-radius:6px;text-decoration:none;font-size:1rem;font-weight:600;display:inline-block;transition:background .2s}
    .btn:hover{background:#a50e1e}
    .btn-blue{background:#0038a8}.btn-blue:hover{background:#002d8a}
...
<body>
<header>
  <h1>🇵🇭 Philippines Work From Home Jobs</h1>
...
<div class="stats-bar">
  ...
  <div class="stat"><b>100%</b><span>Philippines</span></div>
...
<footer>
  ...
  <p style="margin-top:8px;font-size:.85rem">Work From Home Jobs Philippines | Remote Jobs PH | Online Jobs Philippines</p>
</footer>
</body>
</html>`);
});
  ...
  const rows = jobs
    ...
    <div class="job-card">
      ...
      <div class="meta">
        <span class="${j.isRemote ? "remote-badge" : "onsite-badge"}">${j.isRemote ? "🏠 Remote" : "🏢 On-Site"}</span>
        <span class="salary">💰 ${j.salary}</span>
        <span class="location">📍 ${j.city}, Philippines</span>
...
<head>
  <meta charset="UTF-8"/>
  <meta name="viewport" content="width=device-width,initial-scale=1"/>
  <title>Work From Home Jobs Philippines Page ${page} | ${SITE_NAME}</title>
  <meta name="description" content="Browse ${TOTAL_JOBS.toLocaleString()} work from home and remote jobs in Philippines. Page ${page} of ${totalPages}."/>
  <meta name="robots" content="index,follow"/>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    body{font-family:'Segoe UI',Arial,sans-serif;background:#f0f4f8;color:#222}
    header{background:linear-gradient(135deg,#0038a8,#ce1127);color:#fff;padding:25px 20px;text-align:center}
    ...
    .filter-bar a{padding:7px 18px;border-radius:20px;text-decoration:none;font-size:.9rem;border:1px solid #0038a8;color:#0038a8;background:#fff}
    .filter-bar a.active,.filter-bar a:hover{background:#0038a8;color:#fff}
    ...
    .job-card{background:#fff;border-radius:10px;padding:20px;box-shadow:0 2px 8px rgba(0,0,0,.08);border-top:3px solid #0038a8}
    ...
    .btn{background:#ce1127;color:#fff;padding:10px 22px;border-radius:6px;text-decoration:none;font-size:.95rem;font-weight:600}
    .btn-blue{background:#0038a8}.btn:hover{opacity:.9}
    footer{background:#1a1a2e;color:#aaa;text-align:center;padding:25px}
    footer a{color:#7ba7f7}
  </style>
</head>
<body>
<header><h1>🇵🇭 Philippines Remote Jobs — All Listings</h1></header>
<nav>
  <a href="/">🏠 Home</a>
  <a href="/jobs">All Jobs</a>
...
<head>
  ...
  <meta name="description" content="Apply now: ${job.title} at ${job.company}. Salary: ${job.salary}. Location: ${job.location}. Work from home job in the Philippines."/>
  <meta name="robots" content="index,follow"/>
  <link rel="canonical" href="${BASE_URL}/jobs/${id}"/>
  <meta property="og:title" content="${job.title}"/>
  <meta property="og:description" content="Apply for ${job.title} at ${job.company}. ${job.salary}. Philippines remote job."/>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    body{font-family:'Segoe UI',Arial,sans-serif;background:#f0f4f8;color:#222}
    header{background:linear-gradient(135deg,#0038a8,#ce1127);color:#fff;padding:20px;text-align:center}
    header a{color:#fff;text-decoration:none;font-size:.9rem;opacity:.85}
    nav{background:#0038a8;padding:10px 20px;display:flex;gap:15px;flex-wrap:wrap}
    nav a{color:#fff;text-decoration:none;font-size:.95rem;padding:5px 12px;border-radius:4px}
    nav a:hover{background:rgba(255,255,255,.2)}
    .container{max-width:900px;margin:30px auto;padding:0 15px}
    .job-header{background:#fff;border-radius:12px;padding:30px;box-shadow:0 2px 12px rgba(0,0,0,.09);margin-bottom:25px;border-top:4px solid #0038a8}
    .company-tag{font-size:.85rem;background:#e8f0fe;color:#0038a8;padding:5px 15px;border-radius:20px;display:inline-block;margin-bottom:15px;font-weight:700}
    ...
    .badge-ph{background:#fde8e8;color:#ce1127}
    ...
    .apply-box{background:linear-gradient(135deg,#0038a8,#ce1127);border-radius:10px;padding:25px;text-align:center;margin-bottom:25px}
    ...
    .btn-apply{background:#fff;color:#0038a8;padding:14px 40px;border-radius:8px;text-decoration:none;font-size:1rem;font-weight:700;display:inline-block;cursor:pointer;border:none;transition:.2s}
...
<div class="container">
  <div class="job-header">
    ...
    <div class="badges">
      ...
      <span class="badge badge-ph">🇵🇭 Philippines</span>
    </div>
    <div class="info-grid">
...
<head>
  <meta charset="UTF-8"/>
  <meta name="viewport" content="width=device-width,initial-scale=1"/>
  <title>${company} Work From Home Jobs Philippines 2025 | ${SITE_NAME}</title>
  <meta name="description" content="Browse ${JOBS_PER_COMPANY.toLocaleString()} remote jobs at ${company} for Philippines applicants. Work from home, competitive salary, apply now!"/>
  <meta name="robots" content="index,follow"/>
  <link rel="canonical" href="${BASE_URL}/company/${encodeURIComponent(company)}"/>
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    body{font-family:'Segoe UI',Arial,sans-serif;background:#f0f4f8;color:#222}
    header{background:linear-gradient(135deg,#0038a8,#ce1127);color:#fff;padding:30px 20px;text-align:center}
    nav{background:#0038a8;padding:10px 20px;display:flex;gap:15px;flex-wrap:wrap}
    nav a{color:#fff;text-decoration:none;font-size:.95rem;padding:5px 12px;border-radius:4px}
    nav a:hover{background:rgba(255,255,255,.2)}
    ...
    .job-card{background:#fff;border-radius:10px;padding:18px;box-shadow:0 2px 8px rgba(0,0,0,.08);border-top:3px solid #0038a8}
    .job-card h3{font-size:.98rem;margin-bottom:10px;line-height:1.4}
    .job-card h3 a{color:#1a1a2e;text-decoration:none}.job-card h3 a:hover{color:#0038a8}
    .meta{display:flex;flex-wrap:wrap;gap:8px;font-size:.82rem}
    .remote-badge{background:#d4edda;color:#155724;padding:2px 8px;border-radius:12px}
    .onsite-badge{background:#d1ecf1;color:#0c5460;padding:2px 8px;border-radius:12px}
    .salary{color:#28a745;font-weight:600}
...
<body>
<header>
  <h1>🇵🇭 ${company} — Philippines Work From Home Jobs</h1>
...
<div class="container">
  <p class="page-info">Page <strong>${page}</strong> of <strong>${totalPages}</strong> — Showing ${JOBS_PER_COMPANY.toLocaleString()} ${company} jobs for Philippines</p>
  <div class="jobs-grid">${rows}</div>
  <div class="pagination">${prevLink}${nextLink}</div>
</div>
...
<head>
  <meta charset="UTF-8"/>
  <meta name="viewport" content="width=device-width,initial-scale=1"/>
  <title>All Companies Hiring in Philippines | ${SITE_NAME}</title>
  <meta name="description" content="${COMPANIES.length} top international companies hiring remote workers from Philippines. Browse ${TOTAL_JOBS.toLocaleString()} jobs."/>
  <meta name="robots" content="index,follow"/>
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    body{font-family:'Segoe UI',Arial,sans-serif;background:#f0f4f8;color:#222}
    header{background:linear-gradient(135deg,#0038a8,#ce1127);color:#fff;padding:30px;text-align:center}
    nav{background:#0038a8;padding:10px 20px;display:flex;gap:15px;flex-wrap:wrap}
    nav a{color:#fff;text-decoration:none;font-size:.95rem;padding:5px 12px;border-radius:4px}
    nav a:hover{background:rgba(255,255,255,.2)}
    .container{max-width:1200px;margin:30px auto;padding:0 15px}
    .companies-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:14px}
    .company-card{background:#fff;border-radius:10px;padding:18px;box-shadow:0 2px 8px rgba(0,0,0,.08);text-decoration:none;border-top:3px solid #0038a8;transition:.2s;display:block}
    ...
    .cjobs{color:#0038a8;font-size:.85rem;font-weight:600}
    h2{font-size:1.3rem;margin-bottom:20px;color:#0038a8;border-left:4px solid #ce1127;padding-left:12px}
...
<body>
<header>
  <h1>🇵🇭 All Companies Hiring in Philippines</h1>
...
<div class="container">
  <h2>Top International Companies Hiring Filipinos (Work From Home)</h2>
...
// ─── START ────────────────────────────────────────────────────────────────────
app.listen(PORT, () => {
  console.log(`🇵🇭 Philippines Jobs Portal running on http://localhost:${PORT}`);
